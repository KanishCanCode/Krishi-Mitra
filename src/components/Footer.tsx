        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Empowering farmers with transparent, blockchain-based micro loans.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/loans" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Apply for Loan
                </Link>
              </li>
              <li>
